            ...
            if not i.is_corrupted:
                ...
                # Write input to address    
                    ...
                    if type(user_input) == type(1):
                        if debug == True:
                            print("Using input", user_input)
                        self.intcode[self.address_wrapper(i.param_mode[0], 1)] = user_input
                        
                    elif len(user_input)>1:
                        if debug == True:
                            print('Using input:', user_input[self.input_stream_index])
                        self.intcode[self.address_wrapper(i.param_mode[0], 1)] = user_input[self.input_stream_index]
                        self.input_stream_index += 1  
                    else:
